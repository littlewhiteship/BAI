import scrapy
from saleSpider.items import SalespiderItem
import re
...
class SaleSpider(scrapy.Spider):
    ...
    def start_requests(self):
        # 手机
        # yield scrapy.Request('http://www.manmanbuy.com/cpl_57_sell_0_0_0_0_0_0_0_0_0_0_0_1.aspx', self.parse)
        # 数码相机
        # yield scrapy.Request('http://www.manmanbuy.com/cpl_58_sell_0_0_0_0_0_0_0_0_0_0_0_1.aspx', self.parse)
        # 智能手环
        # yield scrapy.Request('http://www.manmanbuy.com/cpl_1747_sell_0_0_0_0_0_0_0_0_0_0_0_1.aspx', self.parse)
        # 移动电源
        # yield scrapy.Request('http://www.manmanbuy.com/cpl_900_sell_0_0_0_0_0_0_0_0_0_0_0_1.aspx', self.parse)
        # 洁面乳
        yield scrapy.Request('http://www.manmanbuy.com/cpl_886_sell_0_0_0_0_0_0_0_0_0_0_0_1.aspx', self.parse)
            ...
            if selector.xpath('./div/div[@class="title"]/div[1]/a/text()').get() is not None:
                ...
                if selector.xpath('./div/div[@class="cost"]/div/span[@class="listpricespan"]/text()').get() is not None:
                    item['price'] = selector.xpath(
                        './div/div[@class="cost"]/div/span[@class="listpricespan"]/text()').get()
                    print(item['price'])
